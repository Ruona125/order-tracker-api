...
const database_1 = __importDefault(require("../../utils/database")); // Import the actual db object or module
//the test to create income
describe("POST /income", () => {
    test("it should create income and respond with status 200", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("GET /income", () => {
    test("it should respond with a list of incomes and status 200", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        jest.spyOn(database_1.default, "select").mockResolvedValue(mockIncomeData);
        // Make a request to the login route to get a valid token
        const loginResponse = yield (0, supertest_1.default)(app_1.default).post("/user/login").send({
            email: "admin@gmail.com",
            password: "admin",
    ...
    test("it should handle errors and respond with status 400", () => __awaiter(void 0, void 0, void 0, function* () {
