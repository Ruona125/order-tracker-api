...
const order_controller_2 = __importDefault(require("./order.controller"));
orderRouter.post("/order", requireAuth_1.authorize, (0, validationMiddleware_1.validation)(orderValidation_1.createOrderSchema), requireAuth_1.staffAuth, order_controller_2.default.single("order_design_artwork"), order_controller_1.createOrder);
