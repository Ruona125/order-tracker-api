...
const s3_setup_1 = require("../../utils/s3-setup");
...
const randomImageName = (bytes = 32) => crypto_2.default.randomBytes(bytes).toString("hex");
...
function viewOrder(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const orders = yield database_1.default.select(database_1.default.raw("o.order_id, o.order_number, o.details, o.cost_of_order, o.start_date, o.end_date, o.status, o.order_design_artwork, c.full_name, c.customer_id FROM orders AS o INNER JOIN customer AS c ON o.customer_id = c.customer_id"));
        if (!orders) {
        ...
        for (let order of orders) {
            if (order.order_design_artwork) {
                try {
                    order.imageUrl = yield (0, s3_setup_1.getObjectSignedUrl)(order.order_design_artwork);
                }
                catch (err) {
                    console.log(err);
...
function viewCertainOrder(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const orders = yield database_1.default
            .select(database_1.default.raw("o.order_id, o.order_number, o.details, o.cost_of_order, o.start_date, o.end_date, o.status, o.order_design_artwork, c.full_name, c.customer_id"))
            .from("orders AS o")
